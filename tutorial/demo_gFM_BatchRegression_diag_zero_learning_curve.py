...
def train(export_filename):
    ...
    for repeat_count in xrange(repeat_times):
        ...
        y = X.dot(w_true) + gFM.A_diag0(U_true, U_true,X.T)-0.5
        y = y.flatten()

        # generate true labels for testing
        y_test = X_test.dot(w_true) + gFM.A_diag0(U_true, U_true,X_test.T) - 0.5
...
if __name__ == '__main__':
    export_filename = './gFM_BatchReg_diag0_convergence_curve.npz'
