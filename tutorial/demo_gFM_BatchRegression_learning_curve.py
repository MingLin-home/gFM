...
def train(export_filename):
    ...
    for repeat_count in xrange(repeat_times):
        ...
        the_estimator = gFM.BatchRegression(rank_k=rank_k, max_init_iter=max_init_iter, learning_rate=1, init_tol=1e-2, tol=0, diag_zero=False)
...
if __name__ == '__main__':
    export_filename = './gFM_BatchReg_convergence_curve.npz'
    ...
    # plot curves
    export_figname = './gFM_BatchReg_prediction_error_curve.png'
